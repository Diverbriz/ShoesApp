...
public class ItemFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container,
        ...
        mBinding = FragmentItemBinding.inflate(getLayoutInflater(), container, false);
        ...
        if(mViewModel.getItem() != null){
            ...
            mBinding.imageSlider.setAdapter(new ImageSliderAdapter(mViewModel.getItem().getImg(), mBinding.imageSlider));
...
//        mBinding.fragmentItemName.setText("123");
    }

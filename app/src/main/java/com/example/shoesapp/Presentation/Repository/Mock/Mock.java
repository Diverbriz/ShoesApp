...
public class Mock implements RepositoryTask {
    ...
    public Mock(){
        ...
        item1.setImg(new ArrayList<>(Arrays.asList("https://firebasestorage.googleapis.com/v0/b/nike-store-94e3e.appspot.com/o/nike-metcon-4.png?alt=media&token=cee42a27-176b-465d-b89a-9f94e9e21d5c")));
        list.add(item1);
        ...
        item2.setPrice(5500);
        item2.setImg(new ArrayList<>(Arrays.asList("https://firebasestorage.googleapis.com/v0/b/nike-store-94e3e.appspot.com/o/nike-metcon-6.png?alt=media&token=e29a028f-e265-409d-a8c6-549b412f4251")));
        list.add(item2);
        ...
        item3.setPrice(7250);
        item3.setImg(new ArrayList<>(Arrays.asList("https://firebasestorage.googleapis.com/v0/b/nike-store-94e3e.appspot.com/o/nike-metcon-5-black.png?alt=media&token=f6c18876-01fb-4ca9-8423-c140a49e4cd7")));
        list.add(item3);
        ...
        item4.setPrice(6000);
        item4.setImg(new ArrayList<>(Arrays.asList("https://firebasestorage.googleapis.com/v0/b/nike-store-94e3e.appspot.com/o/nike-metcon-3.png?alt=media&token=4084bb9a-e410-425e-8d3b-02fa9fe43e25")));
        list.add(item4);
        ...
        item5.setPrice(8000);
        item5.setImg(new ArrayList<>(Arrays.asList("https://firebasestorage.googleapis.com/v0/b/nike-store-94e3e.appspot.com/o/nike-metcon-free.png?alt=media&token=9dd7c8a8-5e6e-42f2-b8b9-3315307c410a")));
        list.add(item5);

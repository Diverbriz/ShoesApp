...
public class VK_API_Logic {
    ...
    public VK_API_Logic() {
        ...
        api_info.put("client_id", "51479013");
        api_info.put("v", "5.131");
        api_info.put("fields", "bdate");
        getRetrofit();
    }
    ...
    public void getProfile(String token, MainActivity activity){
        ...
        api.getUserInfo(api_info, token).enqueue(new Callback<UserResponse>() {
            ...
            public void onResponse(@NonNull Call<UserResponse> call, @NonNull Response<UserResponse> response) {
                if(response.body() != null){
                    ...
                    System.out.println(response.body().getResponse().get(0).toString());
                }
            }
